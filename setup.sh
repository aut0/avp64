...
case $1 in
    ...
    "linux_nvdla") 
        AVP64_LINUX_NVDLA_BUILD="$AVP64_SW/linux/BUILD" 
        AVP64_LINUX_NVDLA_KERNEL_IMAGE="$AVP64_LINUX_NVDLA_BUILD/buildroot/output/linux_nvdla/images/Image"
        AVP64_LINUX_NVDLA_KERNEL_ELF="$AVP64_LINUX_NVDLA_BUILD/buildroot/output/linux_nvdla/build/linux-4.19.4/vmlinux"
        AVP64_LINUX_NVDLA_DTB="$AVP64_LINUX_NVDLA_BUILD/buildroot/output/linux_nvdla/images/avp64_linux_nvdla.dtb"
        AVP64_LINUX_NVDLA_SDCARD="$AVP64_LINUX_NVDLA_BUILD/buildroot/output/linux_nvdla/images/sdcard.img"
        AVP64_LINUX_NVDLA_BOOT="$AVP64_LINUX_NVDLA_BUILD/linux_bootcode/el3/boot.bin"
        ...
        chmod -w "$BUILD_DEBUG/sw/arm64/linux_nvdla/sdcard.img"
        ln -s "$BUILD_DEBUG/sw/arm64/linux_nvdla/sdcard.img" "$BUILD_RELEASE/sw/arm64/linux_nvdla/sdcard.img"
        cp -rv "$AVP64_LINUX_NVDLA_BOOT" "$BUILD_DEBUG/sw/arm64/linux_nvdla/boot.bin"
        ln -s "$BUILD_RELEASE/sw/arm64/linux_nvdla/boot.bin" "$BUILD_RELEASE/sw/arm64/linux_nvdla/boot.bin"
        ;;
    ...
    *)
        echo "Error, specify variant to copy"
        exit 0
        ;;
esac
