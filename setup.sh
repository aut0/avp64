...
AVP64_XEN_SYMS="$AVP64_XEN_BUILD/buildroot/output/dom0/build/xen-git-93ef224d63f9f04a0897d64981c619eb4816c0d3/xen/xen-syms"
...
AVP64_COREMARK_BUILD="$AVP64_SW/coremark/BUILD"
AVP64_COREMARK_ELF="$AVP64_COREMARK_BUILD/coremark/coremark.elf"
AVP64_COREMARK_BIN="$AVP64_COREMARK_BUILD/coremark/coremark.bin"
mkdir -p "$BUILD_DEBUG/sw/arm64/coremark/"
mkdir -p "$BUILD_RELEASE/sw/arm64/coremark/"
cp -rv "$AVP64_COREMARK_ELF" "$BUILD_DEBUG/sw/arm64/coremark"
cp -rv "$AVP64_COREMARK_BIN" "$BUILD_DEBUG/sw/arm64/coremark"
cp -rv "$AVP64_COREMARK_ELF" "$BUILD_RELEASE/sw/arm64/coremark"
cp -rv "$AVP64_COREMARK_BIN" "$BUILD_RELEASE/sw/arm64/coremark"

AVP64_DHRYSTONE_BUILD="$AVP64_SW/dhrystone/BUILD"
AVP64_DHRYSTONE_ELF="$AVP64_DHRYSTONE_BUILD/dhrystone/dhrystone.elf"
AVP64_DHRYSTONE_BIN="$AVP64_DHRYSTONE_BUILD/dhrystone/dhrystone.bin"
mkdir -p "$BUILD_DEBUG/sw/arm64/dhrystone/"
mkdir -p "$BUILD_RELEASE/sw/arm64/dhrystone/"
cp -rv "$AVP64_DHRYSTONE_ELF" "$BUILD_DEBUG/sw/arm64/dhrystone"
cp -rv "$AVP64_DHRYSTONE_BIN" "$BUILD_DEBUG/sw/arm64/dhrystone"
cp -rv "$AVP64_DHRYSTONE_ELF" "$BUILD_RELEASE/sw/arm64/dhrystone"
cp -rv "$AVP64_DHRYSTONE_BIN" "$BUILD_RELEASE/sw/arm64/dhrystone"
