...
protected:
    ...
    virtual bool write_reg_dbg(size_t regno, const void* buf,
                               size_t len) override;
    virtual bool page_size(u64& size) override;
    ...
    virtual bool insert_watchpoint(const range& mem, vcml_access acs) override;
    virtual bool remove_watchpoint(const range& mem, vcml_access acs) override;
...
public:
    ...
    virtual void update_page(u64 page_addr) override;
    ...
    virtual bool disassemble(u8* ibuf, u64& addr, string& code) override;
    virtual u64 program_counter() override;
    virtual u64 stack_pointer() override;
    virtual u64 core_id() override;
    ...
    explicit core(const sc_core::sc_module_name& name, u64 procid, u64 coreid);
