...
#define AVP64_GIC_DISTIF_HIGH   (AVP64_GIC_DISTIF_ADDR + AVP64_GIC_DISTIF_SIZE - 1)
...
#define AVP64_GIC_VIFCTRL_HIGH  (AVP64_GIC_VIFCTRL_ADDR + AVP64_GIC_VIFCTRL_SIZE - 1)

#define AVP64_GIC_VCPUIF_ADDR   (0x10145000ull)
#define AVP64_GIC_VCPUIF_SIZE   (0x00002000ull)
#define AVP64_GIC_VCPUIF_HIGH   (AVP64_GIC_VCPUIF_ADDR + AVP64_GIC_VCPUIF_SIZE - 1)
...
#define AVP64_NVDLA_ADDR        (0x10200000ull)
#define AVP64_NVDLA_SIZE        (0x00020000ull)
#define AVP64_NVDLA_HIGH        (AVP64_NVDLA_ADDR + AVP64_NVDLA_SIZE -1)

#define AVP64_NVDLAEXTMEM_ADDR  (0x40000000)
#define AVP64_NVDLAEXTMEM_SIZE  (0xC0000000)
#define AVP64_NVDLAEXTMEM_HIGH  (AVP64_NVDLAEXTMEM_ADDR + AVP64_NVDLAEXTMEM_SIZE -1)
